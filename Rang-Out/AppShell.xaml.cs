...
namespace Rang_Out
{
    ...
    public sealed partial class AppShell : Page
    {
        ...
        public AppShell()
        {
            ...
            AuthenticationHandler.Logout += AuthenticationHandler_Logout;
            AuthenticationHandler.Login += AuthenticationHandler_Login;
        }

        private void AuthenticationHandler_Login(EventArgs args)
        {
            LogoutNavPaneButton.Visibility = Visibility.Visible;
        }

        private void AuthenticationHandler_Logout(EventArgs args)
        {
            LogoutNavPaneButton.Visibility = Visibility.Collapsed;
